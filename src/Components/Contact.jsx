  ...
  return (
    <>
      <div className="about p-3 relative top-28 aboutus">
        <div className={`content-width  ${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg flex flex-col gap-10`}>
          ...
          >
            ...
            <form action="https://formspree.io/f/xkndqgrk" method="POST">
            <div className="flex flex-col">
              ...
              <input
                ...
                style={{ background: `${bgcolor==="white" ? "#f3f6f6" : "#1D1D1D"}`,color: `${bgcolor==="white" ? "#000000" : "white"}`}}
            ...
            <button className=" my-2 w-32 h-11 hover:bg-blue-500 hover:text-white font-bold rounded-lg btn-sumit border border-blue-500"
            style={{ background: `${bgcolor==="white" ? "#f3f6f6" : "#1D1D1D"}`, color: `${bgcolor==="white" ? "#000000" : "white"}`}}
            >
              Submit
            </button>
